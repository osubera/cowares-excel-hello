...
![http://lh6.googleusercontent.com/-5dEcXHUXrxs/TXf_P7q3PcI/AAAAAAAAADo/rClZ97PRojQ/s1600/shot1.png](http://lh6.googleusercontent.com/-5dEcXHUXrxs/TXf_P7q3PcI/AAAAAAAAADo/rClZ97PRojQ/s1600/shot1.png)

![http://lh3.googleusercontent.com/-HWvQPiiXgUk/TXf_QFjPrxI/AAAAAAAAADs/ysjuQvg9g1A/s1600/shot2.png](http://lh3.googleusercontent.com/-HWvQPiiXgUk/TXf_QFjPrxI/AAAAAAAAADs/ysjuQvg9g1A/s1600/shot2.png)

  1. a book tab button appears for every workbook opened.
  1. click the button to activate the book.
  1. clicking an active tab is to toggle the display between book title and file name.
  1. an input dialog can be shown for books without title property.

## 説明 ##
  1. 開いたブックの数だけボタンが出るので、ボタンを押してブックを切り替える。
  1. アクティブなブックタブを押すと、タイトルとファイル名の表示を交互に切り替える。
  1. ブックプロパティのタイトルが無い場合、入力ダイアログを出すことができる。

# Downloads #

  * [downloads / ダウンロード](http://code.google.com/p/cowares-excel-hello/downloads/list?can=2&q=book_tab)

# How to use / 使い方 #

![http://lh6.googleusercontent.com/-cXLdoPNIQUA/TXf_Qi18uAI/AAAAAAAAADw/1_0hBJ_HVh8/s1600/shot6.png](http://lh6.googleusercontent.com/-cXLdoPNIQUA/TXf_Qi18uAI/AAAAAAAAADw/1_0hBJ_HVh8/s1600/shot6.png)
