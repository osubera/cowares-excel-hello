...
# Introduction #
  ...
  1. a primitive tool to convert an SSF text into an HTML Table

## 概要 ##
  1. SSF テキストをHTMLテーブルタグに変換する、原始的なツール
...
# Details #
  ...
  * see [an example page](http://xlsm.web.fc2.com/screen/ssf_to_html_js_test.html) for details.

## 説明 ##
  * ウェブページ用の JavaScript と、デスクトップ向けの VBScript のツールがある。
  * プラグインなどは一切不要。
  * この原始的なツールは、１枚のワークシートにだけ対応する。
  * [サンプルページ](http://xlsm.web.fc2.com/screen/ssf_to_html_js_ja.html) で動作を試すことができる。

# Code #

### ssf\_to\_html.js (JavaScript) ###
