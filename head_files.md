...
## 説明 ##
  * [list\_files](list_files.md) が作るようなファイル一覧に、テキスト判定情報を付加する。

# Downloads #

  * [downloads / ダウンロード](http://code.google.com/p/cowares-excel-hello/downloads/list?can=2&q=head_files)


# Snapshots #

  * Excel 2000 toolbar
> > ![http://1.bp.blogspot.com/-mGbV-BNyGpc/TcvNLOdMJtI/AAAAAAAAAFs/BaPJiaQkZZs/s1600/shot1.png](http://1.bp.blogspot.com/-mGbV-BNyGpc/TcvNLOdMJtI/AAAAAAAAAFs/BaPJiaQkZZs/s1600/shot1.png)
  * Excel 2007 ribbon
> > ![http://1.bp.blogspot.com/-M-9nwOWbt1E/TcvNMIYS5pI/AAAAAAAAAFw/PKNoLGFeipQ/s1600/shot2.png](http://1.bp.blogspot.com/-M-9nwOWbt1E/TcvNMIYS5pI/AAAAAAAAAFw/PKNoLGFeipQ/s1600/shot2.png)
  * result sheet
> > ![http://1.bp.blogspot.com/-VUE74Cm7cps/TcvNMhH7WjI/AAAAAAAAAF0/JHgY2jf9So0/s1600/shot3.png](http://1.bp.blogspot.com/-VUE74Cm7cps/TcvNMhH7WjI/AAAAAAAAAF0/JHgY2jf9So0/s1600/shot3.png)
...
## 使い方 ##
  ...
  * ツールバーの「判定実行」ボタンを押します。
  * ファイルリストの右方に、判定結果等が書き込まれました。
