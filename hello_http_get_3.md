...
# Details #
  ...
  * [hello\_http\_get](hello_http_get.md) , [hello\_urlencode](hello_urlencode.md) , [hello\_charset\_adodb\_stream](hello_charset_adodb_stream.md) , [hello\_timer](hello_timer.md) and [hello\_array\_collection](hello_array_collection.md) give us everything required.
  * also see [hello\_http\_get\_2](hello_http_get_2.md) and [hello\_http\_post](hello_http_post.md) .
  * we use rough approaches to cut texts here, to avoid precise analysis of html source.

## 説明 ##
  * グー辞書のウェブ辞書引きをエクセルから実行する。
  * [hello\_http\_get](hello_http_get.md) と [hello\_urlencode](hello_urlencode.md) と [hello\_charset\_adodb\_stream](hello_charset_adodb_stream.md) と [hello\_timer](hello_timer.md) と [hello\_array\_collection](hello_array_collection.md) とに必要なものは全部ある。
  * [hello\_http\_get\_2](hello_http_get_2.md) と [hello\_http\_post](hello_http_post.md) も参考に。
...
# How to use #
  ...
  1. from test1() to test3() are executable examples.
  1. Worksheet `Sheet1` contains words to search, try another word.

## 使い方 ##
  1. [ssf\_reader\_primitive](ssf_reader_primitive.md) のような ssf 読み込みツールを使って、下のコードをエクセルブックに変換する。
  1. test1() から test3() までが実行可能な見本。
  1. `Sheet1` ワークシートに検索用の言葉がある。他の言葉に変えて試してみよう。

![http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfSEbsr4I/AAAAAAAAABI/f1E0xqrUCiY/s1600/shot1.png](http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfSEbsr4I/AAAAAAAAABI/f1E0xqrUCiY/s1600/shot1.png)
...
![http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfSl0bDlI/AAAAAAAAABM/W3w1-tciqdI/s1600/shot2.png](http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfSl0bDlI/AAAAAAAAABM/W3w1-tciqdI/s1600/shot2.png)
...
![http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfTMqrL3I/AAAAAAAAABQ/CijKmprVdYA/s1600/shot3.png](http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfTMqrL3I/AAAAAAAAABQ/CijKmprVdYA/s1600/shot3.png)
...
![http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfTrV2fsI/AAAAAAAAABU/Cq5CFnsFBtM/s1600/shot4.png](http://1.bp.blogspot.com/_EUW0nrj9XlM/TSUfTrV2fsI/AAAAAAAAABU/Cq5CFnsFBtM/s1600/shot4.png)