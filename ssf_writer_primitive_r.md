...
# Introduction #
  ...
  1. a primitive tool to convert an R object into an SSF text

## 概要 ##
  1. R オブジェクトをSSF テキストに変換する、原始的なツール
...
# Download #
  ...
  * [download from developer source tree / 開発用レポジトリの最新のソース](http://code.google.com/p/cowares-excel-hello/source/browse/trunk/ssf/ssf_writer.R)
